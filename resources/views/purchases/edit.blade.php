    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit Goods Receipt #{{ $purchase->id }}
            </h2>
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('purchases.update', $purchase) }}" class="space-y-6" id="purchaseForm">
                        ...
                        <select id="product_id" 
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" 
                                        ...
                                        data-stock="{{ $product->warehouse_stock ?? 0 }}"
                    ...
                    <div id="productInfo" class="bg-gray-50 p-4 rounded-md" style="display: none;">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span id="skuCode" class="font-medium"></span>
                            </div>
                            <div>
                                <span class="text-gray-600">Location:</span>
                                <span id="storageLocation" class="font-medium"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="profitCalculation" class="bg-green-50 p-4 rounded-md" style="display: none;">
                        <h3 class="text-sm font-medium text-green-700 mb-2">Cost Review</h3>
    ...
    <script>
        ...
        function updateProductInfo() {
            ...
            if (selectedOption.value) {
                ...
                document.getElementById('storageLocation').textContent = location;
